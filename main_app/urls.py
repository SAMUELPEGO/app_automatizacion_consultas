...
from .api import auth,user_repository,procedimiento_repository,consultas_repository,rotaciones_repository
from . import views
...
urlpatterns = [
       ...
       path('guardia_rotaciones_page', views.guardia_rotaciones_page, name='guardia_rotaciones_page'),
       ...
       path('obtener_rotaciones_por_fecha', rotaciones_repository.obtener_rotaciones_por_fecha, name='obtener_rotaciones_por_fecha'),
       path('eliminar_rotacion_usuario', rotaciones_repository.eliminar_rotacion_usuario, name='eliminar_rotacion_usuario'),
       path('anadir_rotacion_usuario', rotaciones_repository.anadir_rotacion_usuario, name='anadir_rotacion_usuario'),
